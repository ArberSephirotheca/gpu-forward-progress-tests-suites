...
FAILED_DIR = Path("/home/nrehman/gpu-forward-progress-tests-suites/run_reduced_tests/reduce")

# Directory containing reduction config files
REDUCE_CONFIG_DIR = Path("/home/nrehman/gpu-forward-progress-tests-suites/run_reduced_tests/reduce")
